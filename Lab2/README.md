...
Colorbar используется для отображения соответствия между цветом и числовым значением на графиках типа `pcolor()`, `imshow()` и других:
...
y0 = -np.cos(np.exp(x0)) # Значение[README.md](../Lab1/README.md) функции в точке касания
